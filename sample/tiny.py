...
def main():
    ...
    """
    cfg_file_path = 'cfg/yolov3-tiny-unrel.cfg'
    ...
    #bh-modified
    output_tensor_dims['016_convolutional'] = [126, 14, 14]
    output_tensor_dims['023_convolutional'] = [126, 28, 28]
    ...
    """
    weights_file_path = 'weights/tiny.weights'
    ...
    output_file_path = './onnx/tiny.onnx'

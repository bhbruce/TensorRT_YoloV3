...
class DarkNetParser(object):
    ...
    def parse_cfg_file(self, cfg_file_path):
        ...
        """
        with open(cfg_file_path, 'r') as cfg_file:# bh-modified
    ...
    def _next_layer(self, remainder):
        ...
        print(len(remainder.split('\n\n', 1)))
        if len(remainder.split('\n\n', 1)) == 1 :
    ...
    def _parse_params(self, param_line):
        ...
        if param_type == 'layers':
            ...
            if condition_param_value_positive or condition_param_value_negative:
                ...
                print(type(param_value_raw))
                #print(param_type,len(param_value_raw.split(',')))
                #if(len(param_value_raw.split(','))==2):
                #    param_value_raw = param_value_raw.split(',')[0]
...
def main():
    ...
    """
    cfg_file_path = 'cfg/prune_0.2_keep_0.01_yolov3-unrel.cfg'
    #cfg_file_path = 'cfg/yolov3-unrel.cfg'
    ...
    #bh-modified
    output_tensor_dims['082_convolutional'] = [159, 13, 13]
    output_tensor_dims['094_convolutional'] = [159, 26, 26]
    output_tensor_dims['106_convolutional'] = [159, 52, 52]
    ...
    """
    weights_file_path = 'weight/pruned_0.2_yolov3.weights'
    #weights_file_path = 'weight/converted.weights'
